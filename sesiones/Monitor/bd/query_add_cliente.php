...
$conexion = conectarse();
$sql="insert into clientes (doc_id,nombre1,nombre2,apellido1,apellido2,fechadenac,genero,email,telefono,password) values('$doc_id','$nombre1','$nombre2','$apellido1','$apellido2','$fechadenac','$genero','$email','$telefono','$password')";
