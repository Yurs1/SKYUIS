...
$conexion = conectarse();
$sql="update administradores set doc_id='".$doc_id."',nombre1='".$nombre1."',nombre2='".$nombre2."',apellido1='".$apellido1."',apellido2='".$apellido2."',fechadenac='".$fechadenac."',genero='".$genero."',email='".$email."',telefono='".$telefono."',password='".$password."' where doc_id='".$doc_id."'";
